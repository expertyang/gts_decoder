...
SUBROUTINE decode_fm88_sec2 ( arg )
   ...
   SELECT CASE ( section_subgrp )
      ...
      CASE ( 3 ) ! UlaUloUlaUlo/
         arg2 = arg(1:5)
!         WRITE(*,*) 'fm88_sec2 : ', arg2(1:5), is_pack
         IF( arg2(3:4) == '//' ) THEN   ! .AND. is_pack 
            arg2(3:4) = '00'
!            WRITE(*,*) 'fm88_sec2 pack: ', arg2(1:5), 'points left : ', npts
            IF( npts == 1 )  npts = 2
         ENDIF
         section_subgrp = 4
...
!               is_pack = .TRUE.
         ...
         ELSE
            section_subgrp = 2
         ENDIF
!            WRITE(*,*) 'fm88_sec2 : ', arg2(1:5), 'subgrp 5: =>next subgrp : ', section_subgrp
...
!            CALL record_appendr ( str2int(arg(1:5)) , rval , cval )
            CALL record_appendr ( str2int(arg(3:5)) , rval , cval )
